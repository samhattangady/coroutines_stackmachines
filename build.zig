...
pub fn build(b: *std.build.Builder) void {
    ...
    if (!web_build) {
        ...
        const exe = b.addExecutable("coro", "src/main.zig");
        ...
        const exe = b.addSharedLibrary("coro", "src/main.zig", .unversioned);
        exe.setTarget(target);
        exe.addOptions("build_options", options);
        exe.setBuildMode(mode);
        exe.addSystemIncludeDir("src");
        ...
        // b.updateFile("zig-out/lib/coro.wasm", "web/coro.wasm") catch unreachable;
    }
}
